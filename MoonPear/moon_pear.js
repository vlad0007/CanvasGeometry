...
function moon_pear()
{
	...
	gui.add( controller, 'correct', true ).onChange( function() 
	{
		...
		{	
			...
			dSquare = 0.00001;      // Задает положение средних вершин короны.
			vLh = 0.00001;          // определяет смещение центральной точки огранки
			...
			MoonFacetAngle = 64*DEGREE; // угол наклона лунных граней
			MoonRotateAngle = 17*DEGREE; // угол наклона плоскости пересекающей лунные грани
