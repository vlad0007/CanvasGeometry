...
function facet_colors()
{
	...
	var ind = 0;
	// Table
	colors[ind] = "rgb(100, 100, 130)"; ind++;
	
	// Crown
	for (i = 0; i < 8; i++)
	{
		colors[ind] = "rgb(150, 160, 220)"; ind++;
	}	
	
	for (i = 0; i < 8; i++)
	{
		
		colors[ind] = "rgb(180, 170, 250)"; ind++;
	}	
	
	for (i = 0; i < 4; i++)
	{
		colors[ind] = "rgb(160, 200, 250)"; ind++;
		colors[ind] = "rgb(140, 170, 240)"; ind++;
	}
	
	//  Girdle
	for (i = 0; i < 32; i++)
	{
		colors[ind] = "rgb(110, 110, 110)"; ind++;
		colors[ind] = "rgb(150, 150, 150)"; ind++;
	}
	...
	for (i = 0; i < 8; i++)
	{
		colors[ind] = "rgb(180, 150, 200)"; ind++;
		colors[ind] = "rgb(170, 130, 200)"; ind++;	
	}
	
	colors[ind] = "rgb(100, 130, 250)"; ind++;
	colors[ind] = "rgb(100, 140, 250)"; ind++;
	colors[ind] = "rgb(100, 120, 250)"; ind++;
	colors[ind] = "rgb(100, 150, 250)";

};

// Проверка выпуклости модели
function isCorrect_Flower()
{	
	if (correct == false)
	{
		return 1;
